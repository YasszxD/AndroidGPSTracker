...
import com.example.models.FragmentPageAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void initFragment(){
        ...
        fragmentPageAdapter.addFragment(new com.example.models.Cardiaque(R.layout.rythem_cardiaque_activity),"Heart");
